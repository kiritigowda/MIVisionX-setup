...
parser.add_argument('--directory', 	type=str, default='',
                    help='build home directory - optional (default:~/)')
parser.add_argument('--cmake', 		type=str, default='cmake',
                    help='Linux cmake - optional (default:cmake) [options: Ubuntu - cmake; CentOS - cmake3]')
...
os.system('(cd '+buildMake_dir+'; '+linuxCMake +
          ' -DCMAKE_BUILD_TYPE=Release ../MIVisionX )')
